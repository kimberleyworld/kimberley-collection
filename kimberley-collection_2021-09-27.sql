...
# Generation Time: 2021-09-27 12:37:23 +0000
# ************************************************************
...
CREATE TABLE `kimberley-collection` (
  ...
  `mainColour` varchar(50) DEFAULT NULL,
  `catagory` enum('Trippy','Boring','Fun','Silly') DEFAULT NULL,
...
INSERT INTO `kimberley-collection` (`id`, `name`, `mainColour`, `catagory`, `material`, `size`, `heavyness`, `imgUrl`)
VALUES
